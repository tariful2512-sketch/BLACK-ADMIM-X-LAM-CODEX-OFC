...
<head>
    ...
    <title>BLACK ADMIN X LAM CLDEX OFC HOSTING PANEL</title>
...
<body>
    <nav>
        <div class="logo">⚡ BLACK ADMIN X LAM CLDEX OFC</div>
        <div class="nav-links">
...
<html>
<head>
    <title>BLACK ADMIN X LAM CLDEX OFC HOSTING - Login</title>
    <style>
        body {
            background: #050505;
            color: white;
...
<body>
    <div class="container">
        <h2>⚡ BLACK ADMIN X LAM CLDEX OFC</h2>
        {% if error %}
...
<html>
<head>
    <title>Dashboard - BLACK ADMIN X LAM CODEX OFC</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<body>
    <div class="header">
        <div class="logo">⚡ BLACK ADMIN X LAM CODEX OFC</div>
        <div>
...
<html>
<head>
    <title>Pricing - BLACK ADMIN X LAM CODEX OFC</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>My Payments - BLACK ADMIN X LAM CODEX OFC</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>Admin Login - BLACK ADMIN X LAM CODEX OFC</title>
    <style>
        body {
            background: #050505;
            color: white;
...
<body>
    <div class="glow-box">
        ...
        <p>BLACK ADMIN X LAM CLDEX OFCHOSTING</p>
...
<html>
<head>
    <title>Admin Dashboard - BLACK ADMIN X LAM CODEX OFC</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<body>
    <div class="header">
        <div class="logo">🛡️ BLACK ADMIN X LAM CLDEX OFCPANEL</div>
        <div class="nav">
...
<html>
<head>
    <title>Manage Plans - BLACK ADMIN X LAM CODEX OFC</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>Payment Methods - BLACK ADMIN X LAM CODEX OFC</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>Users - BLACK ADMIN X LAM CODEX OFC</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
...
<html>
<head>
    <title>Payments - BLACK ADMIN X LAM CLDEX OFC </title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background: #0a0a0a;
